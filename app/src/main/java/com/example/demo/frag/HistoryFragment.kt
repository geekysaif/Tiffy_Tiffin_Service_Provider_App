...
class HistoryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (requireActivity().isConnectedToNetwork()) {
            ...
            itemsswipetorefresh_history.setColorSchemeColors(Color.WHITE)
            itemsswipetorefresh_history.setOnRefreshListener {
                get_tiffin()
                itemsswipetorefresh_history.isRefreshing = false
            }
        } else {
